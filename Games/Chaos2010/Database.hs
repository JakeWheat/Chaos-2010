...
import qualified Games.Chaos2010.Database.Pieces_to_move
...
import qualified Games.Chaos2010.Database.Moving_pieces
import qualified Games.Chaos2010.Database.Selectable_pieces_with_priorities
import qualified Games.Chaos2010.Database.Board_ranges
import qualified Games.Chaos2010.Database.Empty_squares
import qualified Games.Chaos2010.Database.Corpse_only_squares
import qualified Games.Chaos2010.Database.Empty_or_corpse_only_squares
import qualified Games.Chaos2010.Database.Adjacent_to_tree_squares
import qualified Games.Chaos2010.Database.Empty_and_not_adjacent_to_tree_squares
import qualified Games.Chaos2010.Database.Attackable_squares
import qualified Games.Chaos2010.Database.Creature_on_top_squares
import qualified Games.Chaos2010.Database.Monster_on_top_squares
import qualified Games.Chaos2010.Database.Spell_valid_squares
import qualified Games.Chaos2010.Database.Current_wizard_spell_type_squares
import qualified Games.Chaos2010.Database.Current_wizard_spell_range_squares
...
import qualified Games.Chaos2010.Database.Selected_piece_walk_squares
import qualified Games.Chaos2010.Database.Squares_within_selected_piece_flight_range
import qualified Games.Chaos2010.Database.Selected_piece_fly_squares
import qualified Games.Chaos2010.Database.Selected_piecexy
import qualified Games.Chaos2010.Database.Selected_piece_attackable_squares
import qualified Games.Chaos2010.Database.Selected_piece_walk_attack_squares
import qualified Games.Chaos2010.Database.Selected_piece_fly_attack_squares
import qualified Games.Chaos2010.Database.Selected_piece_in_range_squares
import qualified Games.Chaos2010.Database.Selected_piece_ranged_attackable_squares
...
import qualified Games.Chaos2010.Database.Windows
import qualified Games.Chaos2010.Database.Colours
import qualified Games.Chaos2010.Database.Wizard_display_info
import qualified Games.Chaos2010.Database.Board_sprites1_cache
...
import qualified Games.Chaos2010.Database.Board_sprites
import qualified Games.Chaos2010.Database.Board_square_effects
...
import qualified Games.Chaos2010.Database.Board_beam_effects
import qualified Games.Chaos2010.Database.Board_sound_effects
import qualified Games.Chaos2010.Database.History_sounds
import qualified Games.Chaos2010.Database.History_no_visuals
import qualified Games.Chaos2010.Database.Last_history_effect_id_table
import qualified Games.Chaos2010.Database.Current_effects
import qualified Games.Chaos2010.Database.Current_board_sound_effects
import qualified Games.Chaos2010.Database.Current_board_beam_effects
import qualified Games.Chaos2010.Database.Current_board_square_effects
...
database :: DBInfo
database = DBInfo {dbname = "Games.Chaos2010.Database",
                                   opts = DBOptions {useBString = False},
                                   tbls = [TInfo {tname = "all_database_objects",
                                           ...
                                           TInfo {tname = "triggers",
                                                  cols = [CInfo {cname = "relvar_name",
                                                          ...
                                                          CInfo {cname = "created",
                                                                 descr = (StringT, True)}]},
                                           TInfo {tname = "views",
                                                  cols = [CInfo {cname = "view_name",
                                                                 descr = (StringT, True)},
                                                          CInfo {cname = "table_catalog",
                                                                 descr = (StringT, True)},
                                           ...
                                           TInfo {tname = "moving_pieces",
                                                  cols = [CInfo {cname = "ptype",
                                                          ...
                                                          CInfo {cname = "y",
                                                                 descr = (IntT, True)}]},
                                           TInfo {tname = "selectable_pieces_with_priorities",
                                                  cols = [CInfo {cname = "ptype",
                                                                 descr = (StringT, True)},
                                                          CInfo {cname = "allegiance",
                                                                 descr = (StringT, True)},
                                           ...
                                           TInfo {tname = "board_ranges",
                                                  cols = [CInfo {cname = "x",
                                                          ...
                                                          CInfo {cname = "ty",
                                                                 descr = (IntT, True)}]},
                                           TInfo {tname = "empty_squares",
                                                  cols = [CInfo {cname = "x",
                                                                 descr = (IntT, True)},
                                                          CInfo {cname = "y",
                                                                 descr = (IntT, True)}]},
                                           TInfo {tname = "corpse_only_squares",
                                                  cols = [CInfo {cname = "x",
                                                                 descr = (IntT, True)},
                                                          CInfo {cname = "y",
                                                                 descr = (IntT, True)}]},
                                           TInfo {tname = "empty_or_corpse_only_squares",
                                                  cols = [CInfo {cname = "x",
                                                                 descr = (IntT, True)},
                                                          CInfo {cname = "y",
                                                                 descr = (IntT, True)}]},
                                           TInfo {tname = "adjacent_to_tree_squares",
                                                  cols = [CInfo {cname = "x",
                                                                 descr = (IntT, True)},
                                                          CInfo {cname = "y",
                                                                 descr = (IntT, True)}]},
                                           TInfo {tname = "empty_and_not_adjacent_to_tree_squares",
                                                  cols = [CInfo {cname = "x",
                                                                 descr = (IntT, True)},
                                                          CInfo {cname = "y",
                                                                 descr = (IntT, True)}]},
                                           TInfo {tname = "attackable_squares",
                                                  cols = [CInfo {cname = "x",
                                                                 descr = (IntT, True)},
                                                          CInfo {cname = "y",
                                                                 descr = (IntT, True)}]},
                                           TInfo {tname = "creature_on_top_squares",
                                                  cols = [CInfo {cname = "x",
                                                                 descr = (IntT, True)},
                                                          CInfo {cname = "y",
                                                                 descr = (IntT, True)}]},
                                           TInfo {tname = "monster_on_top_squares",
                                                  cols = [CInfo {cname = "x",
                                                                 descr = (IntT, True)},
                                                          CInfo {cname = "y",
                                                                 descr = (IntT, True)}]},
                                           TInfo {tname = "spell_valid_squares",
                                                  cols = [CInfo {cname = "valid_square_category",
                                                          ...
                                                          CInfo {cname = "y",
                                                                 descr = (IntT, True)}]},
                                           TInfo {tname = "current_wizard_spell_type_squares",
                                                  cols = [CInfo {cname = "x",
                                                                 descr = (IntT, True)},
                                                          CInfo {cname = "y",
                                                                 descr = (IntT, True)}]},
                                           TInfo {tname = "current_wizard_spell_range_squares",
                                                  cols = [CInfo {cname = "x",
                                                                 descr = (IntT, True)},
                                                          CInfo {cname = "y",
                                                                 descr = (IntT, True)}]},
                                           ...
                                           TInfo {tname = "selected_piece_move_squares",
                                                  cols = [CInfo {cname = "x",
                                                          ...
                                                          CInfo {cname = "y",
                                                                 descr = (IntT, True)}]},
                                           TInfo {tname = "selected_piece_walk_squares",
                                                  cols = [CInfo {cname = "x",
                                                                 descr = (IntT, True)},
                                                          CInfo {cname = "y",
                                                                 descr = (IntT, True)}]},
                                           TInfo {tname = "squares_within_selected_piece_flight_range",
                                                  cols = [CInfo {cname = "x",
                                                                 descr = (IntT, True)},
                                                          CInfo {cname = "y",
                                                                 descr = (IntT, True)}]},
                                           TInfo {tname = "selected_piece_fly_squares",
                                                  cols = [CInfo {cname = "x",
                                                                 descr = (IntT, True)},
                                                          CInfo {cname = "y",
                                                                 descr = (IntT, True)}]},
                                           TInfo {tname = "selected_piecexy",
                                                  cols = [CInfo {cname = "ptype",
                                                                 descr = (StringT, True)},
                                                          CInfo {cname = "allegiance",
                                                                 descr = (StringT, True)},
                                           ...
                                           TInfo {tname = "selected_piece_attackable_squares",
                                                  cols = [CInfo {cname = "x",
                                                          ...
                                                          CInfo {cname = "y",
                                                                 descr = (IntT, True)}]},
                                           TInfo {tname = "selected_piece_walk_attack_squares",
                                                  cols = [CInfo {cname = "x",
                                                                 descr = (IntT, True)},
                                                          CInfo {cname = "y",
                                                                 descr = (IntT, True)}]},
                                           TInfo {tname = "selected_piece_fly_attack_squares",
                                                  cols = [CInfo {cname = "x",
                                                                 descr = (IntT, True)},
                                                          CInfo {cname = "y",
                                                                 descr = (IntT, True)}]},
                                           TInfo {tname = "selected_piece_in_range_squares",
                                                  cols = [CInfo {cname = "x",
                                                                 descr = (IntT, True)},
                                                          CInfo {cname = "y",
                                                                 descr = (IntT, True)}]},
                                           TInfo {tname = "selected_piece_ranged_attackable_squares",
                                                  cols = [CInfo {cname = "x",
                                                                 descr = (IntT, True)},
                                                          CInfo {cname = "y",
                                                                 descr = (IntT, True)}]},
                                           ...
                                           TInfo {tname = "spell_cast_chance",
                                                  cols = [CInfo {cname = "spell_name",
                                                          ...
                                                          CInfo {cname = "chance",
                                                                 descr = (IntT, True)}]},
                                           TInfo {tname = "cast_magic_wood_squares",
                                                  cols = [CInfo {cname = "x",
                                                                 descr = (IntT, False)},
                                                          CInfo {cname = "y",
                                                                 descr = (IntT, False)}]},
                                           ...
                                           TInfo {tname = "wizard_display_info",
                                                  cols = [CInfo {cname = "wizard_name",
                                                          ...
                                                          CInfo {cname = "colour",
                                                                 descr = (StringT, False)}]},
                                           TInfo {tname = "board_sprites1_cache",
                                                  cols = [CInfo {cname = "x",
                                                                 descr = (IntT, True)},
                                                          CInfo {cname = "y",
                                                                 descr = (IntT, True)},
                                           ...
                                           TInfo {tname = "board_sprites",
                                                  cols = [CInfo {cname = "x",
                                                          ...
                                                          CInfo {cname = "selected",
                                                                 descr = (BoolT, True)}]},
                                           TInfo {tname = "board_square_effects",
                                                  cols = [CInfo {cname = "id",
                                                                 descr = (IntT, False)},
                                                          CInfo {cname = "subtype",
                                                                 descr = (StringT, False)},
                                           ...
                                           TInfo {tname = "board_sprites1_view",
                                                  cols = [CInfo {cname = "x",
                                                          ...
                                                          CInfo {cname = "selected",
                                                                 descr = (BoolT, True)}]},
                                           TInfo {tname = "board_beam_effects",
                                                  cols = [CInfo {cname = "id",
                                                                 descr = (IntT, False)},
                                                          CInfo {cname = "subtype",
                                                                 descr = (StringT, False)},
                                                          ...
                                                          CInfo {cname = "queuepos",
                                                                 descr = (IntT, False)}]},
                                           TInfo {tname = "board_sound_effects",
                                                  cols = [CInfo {cname = "id",
                                                                 descr = (IntT, False)},
                                                          CInfo {cname = "subtype",
                                                                 descr = (StringT, False)},
                                                          CInfo {cname = "sound_name",
                                                                 descr = (StringT, False)},
                                                          CInfo {cname = "queuepos",
                                                                 descr = (IntT, False)}]},
                                           TInfo {tname = "history_sounds",
                                                  cols = [CInfo {cname = "history_name",
                                                                 descr = (StringT, False)},
                                                          CInfo {cname = "sound_name",
                                                                 descr = (StringT, False)}]},
                                           TInfo {tname = "history_no_visuals",
                                                  cols = [CInfo {cname = "history_name",
                                                                 descr = (StringT, False)}]},
                                           TInfo {tname = "last_history_effect_id_table",
                                                  cols = [CInfo {cname = "last_history_effect_id",
                                                                 descr = (IntT, False)}]},
                                           TInfo {tname = "current_effects",
                                                  cols = [CInfo {cname = "ticks",
                                                                 descr = (IntT, False)},
                                                          CInfo {cname = "queuepos",
                                                                 descr = (IntT, False)}]},
                                           TInfo {tname = "current_board_sound_effects",
                                                  cols = [CInfo {cname = "queuepos",
                                                                 descr = (IntT, True)},
                                                          CInfo {cname = "id",
                                                                 descr = (IntT, True)},
                                                          CInfo {cname = "subtype",
                                                          ...
                                                          CInfo {cname = "ticks",
                                                                 descr = (IntT, True)}]},
                                           TInfo {tname = "current_board_beam_effects",
                                                  cols = [CInfo {cname = "queuepos",
                                                                 descr = (IntT, True)},
                                                          CInfo {cname = "id",
                                                                 descr = (IntT, True)},
                                                          ...
                                                          CInfo {cname = "ticks",
                                                                 descr = (IntT, True)}]},
                                           TInfo {tname = "current_board_square_effects",
                                                  cols = [CInfo {cname = "queuepos",
                                                                 descr = (IntT, True)},
                                                          CInfo {cname = "id",
                                                                 descr = (IntT, True)},
