...
---------------------------------------------------------------------------
module Games.Chaos2010.Database.Selected_piece_fly_attack_squares where
...
-- Table
---------------------------------------------------------------------------
selected_piece_fly_attack_squares :: Table
    Selected_piece_fly_attack_squares
selected_piece_fly_attack_squares = baseTable "selected_piece_fly_attack_squares"
