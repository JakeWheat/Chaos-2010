...
---------------------------------------------------------------------------
module Games.Chaos2010.Database.Selected_piece_attackable_squares where
...
-- Table
---------------------------------------------------------------------------
selected_piece_attackable_squares :: Table
    Selected_piece_attackable_squares
selected_piece_attackable_squares = baseTable "selected_piece_attackable_squares"
